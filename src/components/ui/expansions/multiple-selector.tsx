    ...
    return (
      ...
      >
        ...
        >
          <div className="relative flex flex-wrap gap-1">
            ...
            <CommandPrimitive.Input
              ...
              className={cn(
                'placeholder:text-muted-foreground flex-1 bg-transparent text-xs outline-none',
                {
            ...
            <button
              ...
              className={cn(
                'absolute -top-8 -right-4 flex gap-2 p-0 text-xs',
                (hideClearAllButton ||
                  disabled ||
                  selected.length < 1 ||
        ...
        <div className="relative">
          {open && (
            <CommandList
              className="bg-popover text-popover-foreground animate-in absolute top-1 z-20 w-full rounded-md border shadow-md outline-none"
              onMouseLeave={() => {
